...
- [中] **真题按题型组套**（用户 2026-09-09 倾向）：不硬凑整卷，按真卷配比按题型出「题型套」（LCR 15 道 / LC 5 段 / LA 3 段 / LAT 4 段 / CTW 3 篇 / RDL 10 题 / AP 2 篇 / BS 10 句），同源优先、不够按日期就近借并标纯度；预计 LCR 16 / LC 9 / LA 16 / LAT 18 / CTW 29 / RDL 23 / AP ~35 / BS 27 套。待拍板「借不借」后在 assemble_sets.mjs 加 type_sets 输出。
