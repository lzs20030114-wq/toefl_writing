...
- [中] 真题专区复核余项（2026-09-07 全库复核，报告 data/claudeGen/reports/REALBANK-RECHECK-2026-09-07.md，清单 data/realBank/review-holds.json）：①音频本机听核——LAT 4 条截掉「Module 2」尾巴、rf0708_2_12 开头串音，音频里若还在要重切/重配；②`real_ap_511_1_26#2` 答案键 D vs 独立作答 C，对原截图核；③LC 6 条说话人标签与题干对调，听音频确认后改题干可放行；④放行任何一条 = 删清单行 + 本机重跑 build_bank（成品已过滤，源料在 .codex-tmp）；⑤题池阅读 parse 阶段要保住段落分隔（本次 5 题因「paragraph N」无从定位被扣）。
