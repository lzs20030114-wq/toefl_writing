...
- [中] **真题阅读缺题 483 → 313 → 241 → 217；学术阅读（AP）实际缺题 38 → 26（2026-09-15，报告 REALBANK-LOSS-SYSTEMIC-2026-09-14.md §12 / §12.3 / §12.4）**：
  ...
  **AP 剩 26**：插入句题源料缺屏 5 + 标记校验不过 3（1.28A M1Q30 首个 ■ 在全文最前 / 3.23 M2Q15、5.6_v2 M2Q15 覆盖率 0.88）/
  **答案页疑似印错 4（3.30 M1Q32、3.8 M2Q15、4.20 M2Q13、5.11 M2Q15：Opus 盲解与 DeepSeek 两票一致、与答案页不同，要不要按三方一致答案收待拍板）**/
