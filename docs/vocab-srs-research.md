...
- **句子池** `sentences[]`（≤3 句）：同词在别的文章再遇时「加这句」而非删除；复习轮换；只有一句时每第 3 次改裸词卡。
  依据 Bolger, Balass, Landen & Perfetti 2008、Webb 2008：语境多样性决定能否泛化到新语境，单句反复有「记句子不记词」风险。
  文献没有「隔几次换一句」的数字。
- **释义对准语境义**：收藏弹窗把词典释义按义项拆成可点选项，选中的当主释义、整条留作备份。依据 Bolger 2008：
  释义在场才能补单一语境的短板，前提是释义对得上那句话。
