...
| RDL | 60 组 / 139 题 | **49 / 114** | LC | 36 / 72 | **31 / 62** |
...
**已放行（2026-09-07 第二轮）**
- LC `rf0708_1_15` / `rf0808_1_13` / `rf0622_2_06`：题干与选项里的 the man/the woman、he/she 按逐字稿对调，音频不动。
- LC `rf0620_2_06`：「Then you'd better get on it.」原本并在 woman 末轮里，拆成 man 的独立一轮（5 轮 → 6 轮），口播文本变了 → 音频作废重配（≈ ¥0.08）。
- 6 条改过口播文本的音频已本机补配完成（commit 53e5edb）。
