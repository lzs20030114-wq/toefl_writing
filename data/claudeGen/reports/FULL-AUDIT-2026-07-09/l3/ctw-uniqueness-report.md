...
多解题数: 87 · 第二解按类: 屈折 65 / 功能词 29 / 内容近义 33
...
- 空 9 碎片`th` 原词 **these** ← 第二解: the(inflection)
...
- 空 7 碎片`floo` 原词 **flooding** ← 第二解: floods(inflection)
...
- 空 1 碎片`th` 原词 **their** ← 第二解: the(inflection)
...
- 空 3 碎片`under` 原词 **underwater** ← 第二解: undersea(inflection)
...
- 空 5 碎片`hea` 原词 **heavier** ← 第二解: heavy(inflection)
...
- 空 2 碎片`th` 原词 **their** ← 第二解: the(inflection)
...
- 空 7 碎片`th` 原词 **these** ← 第二解: the(inflection)
...
- 空 10 碎片`th` 原词 **these** ← 第二解: the(inflection)
...
- 空 8 碎片`nea` 原词 **nearly** ← 第二解: near(inflection)
...
- 空 4 碎片`pa` 原词 **parts** ← 第二解: particles(inflection)
...
- 空 10 碎片`pul` 原词 **pulling** ← 第二解: pulled(inflection)
...
- 空 8 碎片`th` 原词 **these** ← 第二解: the(inflection)
...
- 空 5 碎片`conn` 原词 **connected** ← 第二解: connecting(inflection)
...
- 空 8 碎片`miner` 原词 **mineral-rich** ← 第二解: mineral(inflection)
...
- 空 8 碎片`sev` 原词 **several** ← 第二解: seven(inflection)
...
- 空 9 碎片`Dee` 原词 **Deeper** ← 第二解: Deep(inflection)
...
- 空 3 碎片`cal` 原词 **called** ← 第二解: calls(inflection)
- 空 10 碎片`t` 原词 **the** ← 第二解: their(inflection)
### ctw_1781813469055_146472 — environmental_science/wetland restoration
- 空 5 碎片`th` 原词 **these** ← 第二解: the(inflection)
...
- 空 3 碎片`var` 原词 **varies** ← 第二解: vary(content)
...
- 空 1 碎片`th` 原词 **these** ← 第二解: the(inflection)
- 空 2 碎片`li` 原词 **live** ← 第二解: like(content)
- 空 9 碎片`Tu` 原词 **Tube** ← 第二解: Tubeworms(inflection)
...
- 空 10 碎片`buil` 原词 **builders** ← 第二解: building(inflection)
...
- 空 8 碎片`brig` 原词 **brighter** ← 第二解: bright(inflection)
