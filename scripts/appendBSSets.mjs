...
import { genPrompt, reviewPrompt, consistencyPrompt } from "../lib/bsGen/prompts.mjs";
...
// Prompts moved to lib/bsGen/prompts.mjs (single source of truth, also imported
// by scripts/print-bank-prompt.mjs for the Claude routine).
...
async function callModel(prompt) {
  return callDeepSeekViaCurl({
    ...
    timeoutMs: 120000,
    payload: { model: "deepseek-v4-flash", temperature: 0.35, max_tokens: 5000, messages: [{ role: "user", content: prompt }] },
  });
}
