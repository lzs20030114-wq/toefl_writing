...
// 分片可能在任意字节处切开,所以按 "\n" 缓冲成整行再解析;半截行留到下一片。
export async function readSseContent(body) {
...
export async function readUpstreamContent(res) {
...
export async function callDirectOnce(apiKey, params, { totalBudgetMs } = {}) {
