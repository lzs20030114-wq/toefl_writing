...
- Distractor type distribution across the 7-9 items that have distractors:
  - ~50% extra auxiliary (did/do/does): tests no-inversion rule in embedded questions — NEVER use "did" for passive voice items; use "gets", "have", or "been" instead
  - ~30% morphological variant (e.g., choosing/choose, went/go, taken/take, staying/stay): tests tense/aspect
  - ~20% semantic/functional (e.g., no/not, which/what, where/when, who/whom): tests word choice
- Effective chunk count (excluding distractor): 4-8, target 5-7.
- Each chunk max 3 words, lowercase only.
- Avoid isolating prepositions as standalone chunks when ambiguous; bundle with complement (e.g., "for three years" not "for" + "three years").
...
- PROMPT-ANSWER LOGIC RULE (critical): The prompt and answer must form a coherent conversational exchange.
  - If the answer is "X wanted to know / asked / wondered [wh-clause]", the prompt MUST ask about X's question (e.g. "What did X ask?" / "What did X want to know?") — NEVER use the direct form of the wh-clause as the prompt.
  - WRONG: prompt="Where did you go?" answer="Emma wanted to know where I went." (Person A already asked it directly — why would B report Emma asked the same thing?)
  - RIGHT: prompt="What did Emma want to know?" answer="Emma wanted to know where I went."
  - If the answer is a direct first-person reply (e.g. "I did not enjoy…" / "I have not finished…"), the prompt should be a direct question to that person (e.g. "Did you enjoy…?" / "Have you finished…?").
  - The subject of the prompt and the subject/perspective of the answer must be consistent.
