...
- 5.0 (Advanced)：立场鲜明，论证有力且有具体例证；充分互动讨论语境；逻辑连贯、过渡自然；语言准确多样，除「限时写作噪声」（定义见下）外几乎无错误
- 4.5 (High-Intermediate+)：立场清晰，有较好的例证支撑；有效回应他人观点；逻辑清晰；语言好但有个别能力型小错。接近满分但论证深度或语言精度略有不足
- 4.0 (High-Intermediate)：立场明确，有例证但可更具体/有力；回应了他人但互动可更深入；逻辑通顺；语言有多处让读者略微分神、但每一处意思都清楚的能力型小错（动词形态/词性/主谓一致等）
