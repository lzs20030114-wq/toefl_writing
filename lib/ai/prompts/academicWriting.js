...
PROFESSOR POST:
- Length: 200–400 characters (2–4 sentences). Target ~340 chars. Keep it SHORT.
  Real TOEFL professors are concise — 1 sentence of context + 1 question is often enough.
  Do NOT pad with extra background or restate the topic in multiple ways.
...
- Length: 250–400 characters each (3-4 sentences). Target ~330 chars. Be concise.
  Do NOT write more than 4 sentences per student. 3 sentences is ideal.
