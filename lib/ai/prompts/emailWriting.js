...
export const EMAIL_CATEGORIES = [
  { key: "G", name: "Services & Events", topic: "服务与活动", weight: 0.42, examples: "booking/issue with a gym membership, hotel or restaurant reservation, concert/event tickets, a campus event or club activity, a trip booked through a tour company, signing up for a class/workshop, contacting a venue or event organizer about logistics", tones: "planning/coordination, complaint + request, mixed feedback (praise → problem → suggestion), information request" },
  { key: "A", name: "Academic",  topic: "校园学业", weight: 0.20, examples: "deadline extension, grade dispute, course inquiry, thesis guidance, section change, recommendation letter, TA application", tones: "information request, appreciation + request, complaint + request" },
  { key: "D", name: "Peer",      topic: "日常社交", weight: 0.13, examples: "trip planning with a friend, invitation, borrowed-item issue, shared-activity rescheduling", tones: "invitation/proposal, advice-seeking, complaint + request" },
  ...
  { key: "F", name: "Housing",   topic: "住宿", weight: 0.08, examples: "repair request, lease question, utility issue, roommate arrangement, facility outage", tones: "complaint + request, information request, feedback + suggestion" },
  { key: "B", name: "Workplace", topic: "职场工作", weight: 0.04, examples: "internship follow-up, shift coverage, onboarding question", tones: "appreciation + request, advice-seeking" },
  { key: "C", name: "Community", topic: "社区生活", weight: 0.03, examples: "library hours, program feedback, volunteer coordination", tones: "feedback + suggestion, complaint + request" },
];
