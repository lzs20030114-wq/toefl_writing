...
Scenario rules:
- 35–45 words (2–3 sentences)
- Must open with "You are…", "You recently…", or "Your [person]…"
...
- Use simple verbs: Describe, Explain, Suggest, Ask, Thank, Tell, Mention, Offer, Give
- NEVER use adjectives/adverbs in goals — FORBIDDEN words: specific, concise, detailed, workable, reasonable, clear, thorough
...
Other rules:
- "to" must be a concrete name or title — use a creative, unique name (not "Professor Smith" or "Ms. Rivera")${avoidNames}
- "subject" must be a natural email subject line${avoidSubjects}
- Create a completely original scenario — no common templates like "group project" or "restaurant complaint"`;
}
