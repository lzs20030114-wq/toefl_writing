...
export const EMAIL_GEN_PROMPT =
  'Generate 1 realistic TOEFL 2026 email prompt as JSON: {"scenario":"...","direction":"Write an email to [recipient]. In your email, do the following:","goals":["g1","g2","g3"],"to":"...","subject":"..."}. Diversity constraints: vary recipient types (professor, staff, peer, authority figure, editor, customer service), vary context framing (course/admin/internship/community/housing/consumer), vary task phrasing, and include concrete scenario details (time, policy, deadline, or logistics). Keep scenario concise.';
