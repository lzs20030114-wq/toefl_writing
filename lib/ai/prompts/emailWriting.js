...
export const EMAIL_CATEGORIES = [
  { key: "A", name: "Academic",  topic: "校园学业", weight: 0.30, examples: "deadline extension, grade dispute, course inquiry, thesis guidance, section change, recommendation letter, TA application", tones: "information request, appreciation + request, complaint + request" },
  { key: "B", name: "Workplace", topic: "职场工作", weight: 0.20, examples: "colleague feedback, conference advice, internship follow-up, onboarding questions, tool/process concerns, shift coverage", tones: "feedback + suggestion, appreciation + request, advice-seeking" },
  { key: "C", name: "Community", topic: "社区生活", weight: 0.15, examples: "library hours, program feedback, volunteer coordination, local organization suggestion, event planning", tones: "feedback + suggestion, complaint + request, appreciation + request" },
  { key: "D", name: "Peer",      topic: "日常生活", weight: 0.15, examples: "borrowed item issue, noise complaint, trip planning, invitation, shared-activity rescheduling", tones: "advice-seeking, invitation/proposal, complaint + request" },
  { key: "E", name: "Consumer",  topic: "消费售后", weight: 0.10, examples: "product complaint, subscription issue, booking error, service feedback, warranty claim", tones: "complaint + request, information request, feedback + suggestion" },
  { key: "F", name: "Housing",   topic: "日常生活", weight: 0.10, examples: "repair request, lease question, utility issue, roommate arrangement, elevator/facility outage", tones: "complaint + request, information request, feedback + suggestion" },
];
...
Scenario rules (calibrated to 13 real TPO items: range 33-55 words, mean 39):
- 33–55 words (2–4 sentences). Target ~39 words.
- Open with one of these patterns (in order of frequency in real TPO):
  * "You are…" (46%) — establishes role
  * "You recently…" (23%) — establishes triggering event
  * "Your [person]…" (15%) — third-party context
  * "You [other verb]…" (8%) — e.g., "You decided to…"
  * Third-person / passive / situation setup (8%) — e.g., "A new policy was announced…"
- First sentence establishes who the writer is or what happened; remaining sentences add concrete detail
- Include at least one specific detail (a time, event, policy, or object)

Goal rules (calibrated to real TPO: 39 goals observed):
- Exactly 3 goals, each starting with a DIFFERENT verb
- Use simple verbs (frequency-ordered from real TPO): Describe, Explain, Suggest, Ask, Thank,
  Provide, Tell, Mention, Make, Offer, Give, Request
...
Recipient rules (calibrated to real TPO: 46% title+surname / 46% first-name only / 8% role):
- "to" can be any of these natural forms — do NOT force "creative unique" names:
  * Title + surname: "Mr. Williams", "Ms. Clark", "Dr. Patel", "Professor Reed"
  * First name only: "Kevin", "Maria", "Alex", "Jake"
  * Role: "Editor", "Classmates", "Building Manager"
- Common names like "Mr. Williams" or "Ms. Clark" are appropriate — real TOEFL uses them${avoidNames}
- "subject" must be a natural email subject line${avoidSubjects}
