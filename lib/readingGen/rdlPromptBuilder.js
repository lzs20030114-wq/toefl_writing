...
function buildShortRDLPrompt(count = 5, opts = {}) {
  const { genres = [], excludeScenarios = [], excludeSubjects = [], rejectionFeedback = [] } = opts;
  ...
  // Question type planning: mostly detail + inference, occasionally detail + vocabulary_in_context
...
module.exports = { buildRDLPrompt, buildShortRDLPrompt, GENRE_SPECS, SHORT_GENRE_SPECS, QUESTION_TYPE_TEMPLATES };
