...
function buildAPPrompt(count = 3, opts = {}) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    selected.push({ topic: t.topic, subtopic: st, rhetorical: pickRhetorical() });
  }
...
- Options similar length (within 3 words). Correct answer NOT consistently longest
