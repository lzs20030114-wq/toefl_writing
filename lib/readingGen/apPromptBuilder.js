...
// Question type distribution plans calibrated to real ETS AP (65 questions sampled):
//   vocabulary_in_context  20%   factual_detail       20%
//   inference              17%   paragraph_relationship 17%
//   rhetorical_purpose     14%   negative_factual      9%
//   main_idea               3%
// The previous plan under-prescribed paragraph_relationship (8% vs real 17%)
// and over-prescribed inference (20% vs real 17%). Rebalanced below.
const QUESTION_PLANS = [
  ["vocabulary_in_context", "factual_detail", "inference",      "paragraph_relationship", "rhetorical_purpose"],
  ["vocabulary_in_context", "factual_detail", "paragraph_relationship", "inference",     "negative_factual"],
  ["vocabulary_in_context", "factual_detail", "paragraph_relationship", "rhetorical_purpose", "negative_factual"],
  ["vocabulary_in_context", "factual_detail", "inference",      "paragraph_relationship", "rhetorical_purpose"],
  ["main_idea",             "vocabulary_in_context", "factual_detail",   "inference",     "paragraph_relationship"],
];
...
1. **Length** (calibrated to 13 real ETS AP items: mean 317.5, median 323, range 183-443):
   - Target: **280-360 words, 3-4 paragraphs, ~80-95 words per paragraph**.
   - Acceptable range: 200-440 words. Do NOT cap at 250.
   - The previous 180-250 word range was ~30% below real ETS. Real TOEFL AP passages
     are substantially longer than the project prompt previously assumed.
