...
1. **Length** (calibrated to realExam2026: 75 real 2026改后 CTW passages, mean 69, range 47-94):
   - Target: **65-78 words, 4-5 FULL sentences**. Hard minimum 62 words.
   - ⚠️ The generator tends to UNDERSHOOT (recent bank averaged only 56 words / too
     short). Write the full 4-5 sentences — do NOT stop at 3 short ones.
   - Real ETS CTW averages 66 words — do NOT pad to "70-85" target range.
   - The previous "minimum 65" was 18 words above the real ETS minimum (47).
   - Passages must still have enough non-first-sentence content for 10 blanks
     (mechanical blanking takes every other word from sentence 2+), which means
     sentences 2-5 combined need ≥ 20 words. A 50-word passage with a 12-word
     first sentence and 38 words in remaining sentences works fine.
