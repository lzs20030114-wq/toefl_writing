...
function validateAPItem(item) {
  ...
  if (correctLongestCount >= 3) {
    errors.push(`correct_is_longest: ${correctLongestCount}/5 questions have correct as longest option — reject`);
  } else if (correctLongestCount >= 2) {
    warnings.push(`correct_is_longest: ${correctLongestCount}/5 questions — borderline`);
  }
