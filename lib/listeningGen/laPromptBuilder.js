 ...
 *  - Opening: spread across Attention ~21% / Good morning ~17% / direct ~13% /
 *    professor-first-person ~9% / Due-to ~9% / ... (NO opener >21%; realExam2026)
...
### Opening pattern (RECALIBRATED 2026-05-31 to realExam2026, n=78 — NO opener exceeds
### ~21%. The old "64% Attention" was FALSE against real 2026改后 data and made every
### announcement sound identical; first-person-professor and "Due to…" openers were missing):
- ~21% "Attention students, faculty, and staff." / "Attention students."
- ~17% "Good morning/afternoon, ..." (e.g., "Good morning, students.")
- ~13% direct statement (e.g., "The student lounge will be closed this weekend...")
- ~9% first-person PROFESSOR in a classroom (e.g., "I'm pleased to announce that we'll
  have a guest speaker next week...", "I want to remind you that..."). Real's #1 context
  is a classroom/course announcement by a professor — use this often.
- ~9% "Due to..." / "Since..." cause-opener (e.g., "Due to yesterday's heavy rainstorms...")
- ~8% "This is a reminder that..."
- remainder: "Thank you all for...", "We're excited to announce...", "Welcome..." /
  occasional rhetorical-question hook. Vary the opener across items — do not default to "Attention".
...
### Register:
Semi-formal, but NOT bureaucratic. RECALIBRATED 2026-05-31: real announcements average
**~1.9 contractions per 100 words** (the bank was ~0.40 — far too stiff). Contract
naturally — "we'll", "we're", "don't", "you'll", "here's" — especially in the
first-person classroom-professor announcements, which sound the most conversational.
Still uses "Please note", "Please be aware", "We're excited to announce".
