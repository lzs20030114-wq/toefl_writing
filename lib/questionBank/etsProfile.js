...
const TPO_REFERENCE_PROFILE = Object.freeze({
  ...
  // Given word (prefilled) ratio: 40/60 = 67% of questions have a pre-placed hint word.
  // Per 10-question set: target 6-7 items with prefilled, 3-4 without.
  // Length distribution: 1-word 10%, 2-word 56%, 3-word 34% (from 32 prefilled TPO questions).
  givenWordRatio: 0.67,
});
