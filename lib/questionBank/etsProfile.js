...
const ETS_STYLE_TARGETS = Object.freeze({
  ...
  // Max 9 (not 8) to prevent assembly deadlock when pool skews embedded-heavy
  embeddedMin: 5,
  embeddedMax: 9,
...
const TPO_REFERENCE_PROFILE = Object.freeze({
  ...
  // Given word (prefilled) ratio: 51/60 = 85% of questions have a pre-placed hint word.
  // Per 10-question set: target 8-9 items with prefilled, 1-2 without.
  // Prefilled is the SUBJECT (pronoun "I/She" or subject NP "the professor"), not the object.
  givenWordRatio: 0.85,
});
