...
function detectAdvancedGrammarSignals(question) {
  ...
  const hasReporting =
    ...
    /\b(wanted to know|asked|curious about|found out|needed to know|was wondering|wants to know|would love to know|wondered|inquired|needed to find out|would like to know)\b/.test(answer);
