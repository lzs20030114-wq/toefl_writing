...
// "再做两套看看" snoozes the survey instead of dismissing it: it's stored as a
// dismissed row flagged { snoozePending: true }, and the check route re-shows it
// once the user finishes this many more practice sessions. The snooze fires at
// most once — a second snooze (or the ×) converts it to a permanent dismiss.
export const FIRST_SET_SURVEY_SNOOZE_SETS = 2;
