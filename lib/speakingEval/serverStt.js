...
export async function transcribeWithServer(audio, opts = {}) {
  ...
  return {
    ...
    // Stored consent version (null if never versioned). Lets callers re-prompt
    // legacy v1 consenters onto the v2 disclosure without blocking transcription.
    consentVersion: typeof body.consent_version === "number" ? body.consent_version : null,
  };
}
