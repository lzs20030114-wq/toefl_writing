...
## Difficulty distribution (2026改后 real-exam standard):
- 1-2 easy (6-9 words, 5-6 chunks, simple direct statement or question)
- 6-7 medium (8-11 words, 6-7 chunks, one clear structure)
...
- Direct questions: 1-2 items (~14%), INCLUDING about 1 wh-question
  (What/Why/How/Where/Which...). has_question_mark=true, real inversion.
