...
/**
 * @deprecated Daily usage is now metered server-side in /api/ai at the point of
 * the AI call (the single authoritative counter that can't be bypassed). This
 * client-side consume is no longer called by the app; POST /api/usage remains
 * only for backward compatibility. Do not wire new call sites to it.
