...
// text; if nothing at all anchors (echo is alien to the source), the parsed
// result is returned unchanged as a defensive fallback.
export function reanchorToSource(parsed, sourceText) {
  ...
  if (remapped.length === 0) return parsed;
